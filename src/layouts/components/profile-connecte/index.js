        ...
        <div className="dropdown profile-1">
            <Dropdown>
                <Dropdown.Toggle
                    as={DropDownToggle}
                    className={
                        "nav-link pl-2 pr-2 leading-none d-flex text-dark"
                    }
                    variant="secondary"
                >
                    <span>
                        {userInfo?.avatar ? (
                            <img
                                src={`${API_STORAGE_URL}/${userInfo.avatar}`}
                            />
                        ) : (
                    ...
                    <div className="text-center mt-1 d-none d-xl-block">
                        <h6 className="text-dark mb-0 fs-13 font-weight-semibold">
                            {userInfo
                ...
                <Dropdown.Menu as={DropDownMenu} variant="dark">
                    <div className="dropdown-menu dropdown-menu-right dropdown-menu-arrow">
                        ...
                        <Link
                            ...
                            href="#"
                        >
                            <i className="dropdown-icon zmdi zmdi-edit"></i> Mes
                            accès
                        </Link>
                        {userInfo?.role === "user" && (
                            <Link
                                ...
                                href="#"
                            >
                                <i className="dropdown-icon zmdi zmdi-card"></i>{" "}
                                Mes paiements
                            </Link>
                        )}
