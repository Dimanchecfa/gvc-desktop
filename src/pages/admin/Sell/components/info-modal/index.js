        ...
        <Modal.Body>
          <Row>
            <Col md={4} sm={12} xs={12}>
              <Card>
                <Card.Header>
                  <Card.Title as="h5">Informations de l'engin vendu</Card.Title>
                </Card.Header>
                <Card.Body>
                  ...
                  <ul class="list-group list-group-bordered mt-4">
                    ...
                    <li class="list-group-item">
                      <b>Marque</b> <a class="text-muted float-right text-bold">
                        {data?.moto?.marque}
                      </a>
                    </li>
                    <li class="list-group-item">
                      <b>Modele</b> <a class="text-muted float-right text-bold">
                        {data?.moto?.modele}
                      </a>
                    </li>
                    <li class="list-group-item">
                      <b>Couleur</b> <a class="text-muted float-right text-bold">
                        {data?.moto?.couleur}
                      </a>
                    </li>
                    <li class="list-group-item">
                      <b>Prix</b> <a class="text-muted float-right text-bold">
                        {data?.prix_vente}
                      </a>
                    </li>
                    <li class="list-group-item">
                      <b>CMC</b> <a class="text-muted float-right text-bold">
                        {data?.is_certificat ? (
                  ...
                  <Card>
                    ...
                    <Card.Body>
                      <ul class="list-group list-group-bordered">
                        ...
                        <li class="list-group-item">
                          <b>Commercial responsable</b>{" "}
                          <a class="text-muted float-right text-bold">
                            {data?.commerciale?.pseudo}
                          </a>
                        </li>
                      </ul>
                    </Card.Body>
